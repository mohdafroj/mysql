...
export class DataService {
	...
	private approvalStripData = new BehaviorSubject({message: "", lockdowns: "", paypal: 0, homeBanner: 0});
	currentApprovalStripData = this.approvalStripData.asObservable();
	...
	updateApprovalStripData (obj) {
		this.approvalStripData.next(obj);
	}
