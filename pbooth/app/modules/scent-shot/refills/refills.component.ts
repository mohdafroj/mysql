...
export class RefillsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        const title = 'Buy Refills Pack of Perfume Scent Shot';
        const metaDescription = `Buy super saver perfume refill pack of scent shot at low price. Perfumebooth offers
            100% original and genuine perfumes of top international brands.`;
        this.title.setTitle(title);
        const keyword: MetaDefinition = { name: 'keywords', content: `perfume scent shot, scent shot, luxury perfume,
            international brands perfumes, scent shot refill pack, perfume for men, perfume for girls`};
        ...
        this.seo.ogMetaTag(
			'Buy Refills Pack of Perfume Scent Shot',
			'Buy super saver perfume refill pack of scent shot at low price. Perfumebooth offers 100% original and genuine perfumes of top international brands.',
			'https://www.perfumebooth.com/assets/images/scent_shot/vial-or-perfume.png'
		);
