...
export class ProductsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        const title = 'Buy Perfume LightR || Best Niche Perfume Brands';
        ...
        const keyword: MetaDefinition = { name: 'keywords', content: `Perfume LightR, LightR, luxury perfume, international
            brands perfumes, LightR refill pack, perfume for men, perfume for girls`};
        ...
        this.seo.ogMetaTag(
			'Buy Perfume LightR || Best Niche Perfume Brands',
			...
			'https://www.perfumebooth.com/assets/images/home/lightr.png'
		);
    ...
    getProducts() {
        ...
        prms = prms.append('page', 'lightr-products');
