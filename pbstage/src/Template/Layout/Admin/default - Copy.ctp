...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?= $this->Url->build('/admin/dist/css/skins/skin-blue.min.css') ?>">
	</head>
  ...
  <header class="main-header">
	<?php echo $this->Html->link(__('Dashboard'), ['controller'=>'Users', 'action'=>'dashboard'], ['class' => 'logo']); ?>
    <!-- Header Navbar -->
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?= $this->Url->build('/admin/dist/img/user2-160x160.jpg') ?>" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= $this->Url->build('/admin/') ?>dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">Mohd Afroj</a>. </strong> All rights reserved.
  </footer>
  ...
  <!-- Add the sidebar's background. This div must be placed
	...
	<!-- iCheck -->
	<script src="<?= $this->Url->build('/admin/dist/js/app.min.js') ?>"></script>
</body>
</html>
