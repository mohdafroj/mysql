            ...
            <table class="col-xs-12 table-bordered table-hover table-condensed no-padding no-border">
                <thead>
                    <tr>
                        ...
                        <th width="10%"><?= $this->Paginator->sort('goods_tax', 'Tax Amount') ?></th>
                        <th><?= $this->Paginator->sort('payment_amount', 'Sale Amount') ?></th>
           ...
           <?php
                ...
                foreach ($orders as $value):?>
                    <tr>
                        ...
                        <td data-title="Tax Amount"><?php echo $this->Admin->priceLogo.number_format(($value->payment_amount - (($value->payment_amount * 100)/118)), 2); ?></td>
                        <td data-title="Order Amount"><?php echo $this->Admin->priceLogo; ?> <?= number_format($value->payment_amount, 2) ?></td>
            ...
            <?php else:?>        
                    <tr>
                        <td colspan="11" class="text-center"><strong>Sorry, no record found!</strong></td>
                    </tr>
            <?php endif; ?>        
                </tbody>
            </table>           
