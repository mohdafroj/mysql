...
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?=$this->Form->text('subject', ['value' => $mailer->subject, 'class' => 'form-control', 'placeholder' => 'Enter mailer subject', 'data-emojiable'=>'true','data-emoji-input'=>'unicode']);?>
                                        <span class="text-red">
										    <?php
    ...
    ?>
            ...
            <div class="col-sm-6 col-xs-12 flex_box no-padding-left xs-no-padding"><!-- start of col_div -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button type="submit" class="btn btn-div-buy btn-1b btn-sm-long">Sent Mailer</button>
                                    </div>
                                </div>
                ...
                <div class="col-sm-6 col-xs-12 flex_box no-padding-left xs-no-padding"><!-- start of col_div -->
                    <div class="box box-default"><!-- start of box_div -->
                        <div class="box-header with-border">
                            <h3 class="box-title">Mailer Stats</h3>
                        </div>
                        <div class="col-sm-12 col-xs-12 flex_box_content price_detail"><!-- start of box_content -->
                            <div class="box-body">
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer clearfix">
                                ...
                                <div class="col-md-2 text-right">
                                    <button type="button" class="btn btn-danger btn-sm" onClick="searchStats();">Search</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Modal -->
<div class="modal fade" id="ConfirmSendMailer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <?=$this->Form->create(null, ['url' => ['action' => 'send', $bucketId, 'key', md5($bucketId)], 'enctype' => 'multipart/form-data', 'id' => 'sendMailerForm', 'class' => 'form-horizontal', 'novalidate' => true])?>
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" id="autoCloseMailerPopup" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title text-center" id="myModalLabel"><strong>Send mailer to Customers</strong></h4>
                </div>
                <div class="modal-body" id="sendMailerMessage">
                    Do you want really to send this mailer!
                </div>
                <div class="modal-footer">
                    <input type="hidden" id="mailerId" name="id" value="<?php echo $mailer->id; ?>" />
                    <button type="button" onClick="ConfirmSendMailer();" class="btn btn-danger btn-sm active">Confirm</button>
...
$(document).ready(function(){
    ...
    searchStats();//call stats function for mailer stats
});
    ...
    function searchStats(){
            ...
            var catId = <?php echo $mailer->id ?? 0; ?>;
...
<?=$this->Html->script('/admin/emoji/lib/js/config.js')?>
<?=$this->Html->script('/admin/emoji/lib/js/util.js')?>
<?=$this->Html->script('/admin/emoji/lib/js/jquery.emojiarea.js')?>
<?=$this->Html->script('/admin/emoji/lib/js/emoji-picker.js')?>
...
<script>
      $(function() {
        ...
        window.emojiPicker = new EmojiPicker({
          ...
          assetsPath: '<?php echo $this->Url->build('/admin/emoji/lib/img/'); ?>',
