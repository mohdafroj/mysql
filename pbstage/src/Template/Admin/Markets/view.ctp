...
if ($value->status == 'active') {
    echo $this->Html->link(__('<i class="fa fa-send"></i> Send'), '#ConfirmSendMailer', ['data-toggle' => 'modal',
...
<div class="modal fade" id="ConfirmSendMailer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <?=$this->Form->create(null, ['url' => ['action' => 'send', $bucketId, 'key', md5($bucketId)], 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal', 'id' => 'sendMailerForm', 'novalidate' => true])?>
