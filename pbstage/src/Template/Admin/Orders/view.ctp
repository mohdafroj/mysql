                        ...
                        <div class="col-sm-12 col-xs-12 row-flex row-flex-wrap no-padding margin-md-top"><!-- start of middle_content -->
                                    ...
                                    <div class="col-sm-12 col-xs-12 flex_box_content"><!-- start of box_content -->
                                        <div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_1 -->
                                            ...
                                            <p class="col-sm-7 col-xs-6 no-padding-left xs-no-padding">
                                                <?= h($order->shipping_firstname) ?> <?= h($order->shipping_lastname) ?><br />
                                            </p>
                                            <p class="col-sm-5 col-xs-6 no-padding-left xs-no-padding">
                                                Address:
                                            </p>
                                ...
                                <div class="box box-default"><!-- start of box_div -->
                                    <div class="col-sm-12 col-xs-12 flex_box_content"><!-- start of box_content -->
                                        <div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_1 -->
                                            ...
                                            <p class="col-sm-12 col-xs-12 text-center"><?= $barcode['tracking_code']; ?></p>
                                            <p class="col-sm-12 col-xs-12 text-center">
                                                <?php
                            ...
                            <div class="col-sm-12 col-xs-12 flex_box no-padding responsive-mobile-table"><!-- start of col_div -->
                                <div class="box box-default"><!-- start of box_div -->
                                    <table class="col-xs-12 table-bordered table-hover table-condensed no-padding no-border">
										...
										<tbody>
											<?php
											$counter = $totalQty = $subTotal = $discountTotal = $rowTotal = $totalTax = 0;
											...
											<tr class="total_div">
												...
												<td data-title="Tax Percentage" class="hidden-xs"></td>
												<td data-title="Tax Amount" class="text-bold">Subtotal</td>
                                        ...
                                        <?= $this->Form->create(null, ['class' => 'form-horizontal', 'method'=>'post', 'id' => 'comment_order_form', 'autocomplete' => 'off']); ?>
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?= $this->Form->select('status', $this->Admin->orderStatus, ['value'=>$order->status,'default'=>'','empty'=> TRUE,'class'=>'form-control'])?>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-sm-6 col-xs-12 flex_box no-padding-right xs-no-padding"><!-- start of col_div -->
                                <div class="box box-success"><!-- start of box_div -->
                                    ...
                                    <div class="col-sm-12 col-xs-12 flex_box_content price_detail"><!-- start of box_content -->
										<div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_1 -->
											<p class="col-sm-7 col-xs-7 no-padding-left xs-no-padding">Subtotal (Inc. Tax)</p>
										...
										<div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_1 -->
											...
											<p class="col-sm-5 col-xs-5 no-padding-right xs-no-padding"><?php echo $this->Admin->priceLogo.number_format($total_tax, 2); ?></p>
										</div><!-- end of row_1 -->
										...
										<div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_3 -->
											<p class="col-sm-7 col-xs-7 no-padding-left xs-no-padding text-bold">Grand Total (Incl. Tax)</p>
							...
							<?php   if( count($couponData) ){ ?>			
										...
										<div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_3 -->
											...
											<p class="col-sm-5 col-xs-5 no-padding-right xs-no-padding"><?php echo $this->Admin->priceLogo.number_format($couponData['couponDiscount'],2); ?></p>
										</div><!-- end of row_3 -->	
							<?php   } ?>
                                        <div class="col-sm-12 col-xs-12 no-padding"><!-- start of row_3 -->
											<p class="col-sm-7 col-xs-7 no-padding-left xs-no-padding text-bold">Placed By:</p>
											<p class="col-sm-5 col-xs-5 no-padding-right xs-no-padding"><?php echo $order->is_admin_order ? 'Admin':'Customer'; ?></p>
										</div><!-- end of row_3 -->	
									</div><!-- end of box_content -->
