<?php echo $this->Element('Admin/Shopping/top_menu');
?>
										...
										<div class="col-sm-9">
											<div class="col-sm-6 col-xs-12 no-padding-left xs-no-padding">
												<div class="input-group date">
													...
													<?=$this->Form->select('discount_type', $this->Admin->discountType, ['value' => 'percentage', 'style' => 'width:100%;', 'class' => 'form-control'])?>
												</div>
												<div class="text-red">
											...
											<div class="col-sm-6 col-xs-12 no-padding-right xs-no-padding">
												<div class="input-group date">
													...
													<?=$this->Form->text('discount_value', ['class' => 'form-control', 'style' => 'width:100%;', 'value' => 0]);?>
												</div>
												<div class="text-red">
