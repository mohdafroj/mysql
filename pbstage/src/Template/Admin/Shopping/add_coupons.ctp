                        ...
                        <td data-title="Created Date">
                            <div class="col-sm-6 col-xs-12 no-padding-left xs-no-padding">
                                <div class="input-group date">
                                    ...
                                    <?= $this->Form->text('createdFrom', ['value'=>$createdFrom, 'id'=>'datepicker1', 'class'=>'form-control', 'placeholder'=>'Search by created date from!']); ?>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12 no-padding-right xs-no-padding">
                                <div class="input-group date">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <?= $this->Form->text('createdTo', ['value'=>$createdTo, 'id'=>'datepicker2', 'class'=>'form-control', 'placeholder'=>'Search by created date to!']); ?>
                                </div>
                            </div>   
                        </td>
