										...
										<div class="col-sm-9">
											...
											<span class="text-red">
												<?php
													...
													echo $error['sku_code']['skuCode'] ?? NULL; 
												?>
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group date" style="width:100%;float:left;margin-right:1%;">
												...
												<span class="text-red"><?= $error['offer_price']['decimal'] ?? NULL; ?></span>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group date" style="width:50%;float:left;margin-right:1%;">
												...
												<span class="text-red"><?= $error['offer_from']['dateTime'] ?? NULL; ?></span>
											</div>
											<div class="input-group date" style="width:49%;">
												...
												<span class="text-red"><?= $error['offer_to']['dateTime'] ?? NULL; ?></span>
											</div>
											<span class="text-red"><?= $error['offer_to']['offerTo'] ?? NULL;?></span>
										</div>
									</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											...
											<span class="text-red"><?= $error['sort_order']['_empty'] ?? NULL; ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
