<?php
    echo $this->Element('Admin/Pgs/top_menu');
?>
                            ...
                            <div class="col-sm-6 col-xs-6 flex_box_content price_detail"><!-- start of box_content -->
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											<?= $this->Form->select('code', $this->Admin->paymentGateway, ['empty'=>false,'style'=>'width:100%;','class'=>'form-control'])?>
                                        </div>
                                    </div>
									<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Sort Order: <span class="text-red">*</span></label>
                                        <div class="col-sm-9">
                                        	<?= $this->Form->text('sort_order', ['class'=>'form-control', 'placeholder'=>'Enter sort order']); ?>
											<span class="text-red">
												<?php
													echo $error['sort_order']['_empty'] ?? NULL; 
													echo $error['sort_order']['integer'] ?? NULL; 
													echo $error['sort_order']['message'] ?? NULL; 
												?>
											</span>
                                        </div>
                                    </div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="text-red"><?= isset($error['status']['inList']) ? $error['status']['inList']:NULL;?></span>
										</div>
									</div>
									<div class="form-group">
