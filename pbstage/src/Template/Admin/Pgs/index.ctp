        ...
        <div class="col-sm-12 col-xs-12 table_view responsive-mobile-table"><!-- start of table -->
           ...
           <?php foreach ($pgs as $value):?>         
                    <tr>
                        ...
                        <td class="text-center" data-title="Fees"><?= $value->code ?></td>
                        <td class="text-center" data-title="Fees"><?= $this->Admin->priceLogo.$this->Number->format($value->fees) ?></td>
                        ...
                        <td class="text-center" data-title="Created"><?= date('Y-m-d', strtotime($value->created)); ?></td>
                        <td class="text-center" data-title="Modified"><?= date('Y-m-d', strtotime($value->modified)); ?></td>
