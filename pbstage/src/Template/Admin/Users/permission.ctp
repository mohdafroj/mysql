                ...
                <div class="box box-default">
                    ...
                    <div class="col-sm-12 col-xs-12 flex_box_content price_detail">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-12 col-xs-12 flex_box no-padding responsive-mobile-table">
                                <!-- start of col_div -->
                                <div class="box box-default">
                                    <!-- start of box_div -->
                                    <div class="box-header with-border" style="margin-bottom:25px;">
                                        <h3 class="box-title"><?= $user->firstname ?> of Permission Management</h3>
                                                ...
                                                <ul class="sidebar-menu">
                                                    ...
                                                    <li class="treeview active">
                                                        ...
                                                        <ul class="treeview-menu">
                                                            ...
                                                            <li class="treeview active">
                                                                <a href="#">
                                                                    <label style="cursor:pointer;"><i class="fa-folder-o"></i> <?php echo $contrl; ?></label><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                                                                </a>
                                                                <ul class="treeview-menu custom-control custom-checkbox">
                                                                    <?php foreach ($method as $key => $methodName) {                                                                      ?>
                                                                        <li class="treeview"> <?= $this->Form->input($contrl . '[' . $key . ']', ['checked' => $methodName, 'class' => 'custom-control-input', 'type' => 'checkbox', 'label' => false]); ?><label class="custom-control-label" for="defaultUnchecked"><?php echo $key; ?></label>
                                                                        </li>
                                                                    <?php } ?>
                                                                </ul>
                                                            </li>
