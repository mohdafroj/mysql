...
<?= $this->Form->create($user, ['context' => ['validator' => 'adminProfile'], 'class' => 'form-horizontal', 'novalidate'=>true]) ?>
<!-- Main content -->
                    ...
                    <div class="box box-default"><!-- start of box_div -->
                        <div class="col-sm-12 col-xs-12 flex_box_content price_detail"><!-- start of box_content -->
                            ...
                            <label class="col-sm-3 control-label">Parent Name </label>
                                    <div class="col-sm-9">
                                        <h4 class="col-sm-3 control-label"><?php echo $parentDetails['username'] ?? 'Owner';?> </h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                    	...
                                    	<span class="text-red"><?= (isset($error['email']['valid-email'])) ? $error['email']['valid-email']:null; ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                    	<?= $this->Form->select('Users.is_active', $this->Admin->siteStatus, ['empty'=>false,'style'=>'width:100%;','class'=>'form-control'])?>
