...
<header class="row">
    <div class="header-image"><?= $this->Html->image('admin/header.jpg',['fullBase'=>true]) ?></div>
    <div class="header-image"><?= $this->Html->image('cake.logo.svg',['fullBase'=>true]) ?></div>
    <div class="header-title">
        <h1>Afroj Welcome to CakePHP <?= Configure::version() ?> Red Velvet. Build fast. Grow solid.</h1>
    </div>
</header>
