<section class="content col-sm-12 col-xs-12 no-padding">
		...
		?>
                    <div class="text-center" style="width:100%; float:left;">
                        <img src="data:image/png;base64,<?= $barcode;?>" width="250px" height="160px" alt="<?= $invoice->tracking_code;?>" />
                    </div>
                    <div style="width:100%; float:left;">
                        <div style="width:33%; float:left;">
                            <p style="font-size:28px;"><?php echo $couriers[$invoice->pickup_id] ?? '&nbsp;'; ?></p>
                        </div> 
                        <div style="width:34%; float:left; text-align:center;">
                            <h4 class="text-center"><?= $invoice->tracking_code;?></h4>
                        </div> 
                        <div style="width:33%; float:left; text-align:right;">
                            <p style="font-size:14px;"><?= $hubCode;?></p>
                        </div>                         
                    </div> 
