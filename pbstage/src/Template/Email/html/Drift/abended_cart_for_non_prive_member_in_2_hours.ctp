                                    ...
                                    <tr>
                                    	...
                                    	<td>
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:20px; color:#363636; margin:0; text-align:center;">
                                                            <b>Free shipping</b>
                                                        </p>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                	<td>
                                                        <p style=" color:#363636; margin:0; text-align:center;">
                                                            <span style="border: 1px dashed #38b8bf;display: inline-block;padding: 5px 8px 2px;font-size: 30px;line-height: 28px;font-weight: bold;">PBFREESHIP</span>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0; text-align:center;">
                                                            Complete your purchase to grab this limited time offer.
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td style="padding:0; text-align:center;">
                                                        <a href="https://www.perfumebooth.com/checkout/cart" target="_blank" style="background-color:#38b8bf; text-decoration:none; padding:8px 5px; font-size:20px; font-weight:bold; color:#fff; white-space:nowrap; text-transform:uppercase; display:inline-block; width:150px; text-align:center;">
                                                            Shop Now
                                                        </a>
                                                    </td>
                                                </tr>
