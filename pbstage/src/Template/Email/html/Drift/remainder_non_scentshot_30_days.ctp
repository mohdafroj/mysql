                                    ...
                                    <tr>
                                    	...
                                    	<td>
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:28px; color:#363636; margin:0; text-align:center;">
                                                            <b>No worries!</b>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0; text-align:center;">
                                                            Get your another round right now.
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td style="padding:0; text-align:center;">
                                                        <a href="https://www.perfumebooth.com"  target="_blank" style="background-color:#38b8bf; text-decoration:none; padding:8px 5px; font-size:20px; font-weight:bold; color:#fff; white-space:nowrap; text-transform:uppercase; display:inline-block; width:200px; text-align:center;">
                                                        Start Shopping
                                                        </a>
                                                    </td>
                                                </tr>
