                                        	...
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td>
                                                        ...
                                                        Hi <?php
                                                            echo (isset($customer['name']) && !empty($customer['name'])) ? $customer['name']:'Customer';
                                                            ?>,
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0; text-align:center;">
                                                            Is your Scent Shot feeling empty?
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0; text-align:center;">
                                                            Fill it up now with exclusive offer just for you
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0; text-align:center; font-weight:bold;">
                                                            Here is
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:50px; color:#38b8bf; margin:0;line-height: 40px;padding: 5px 0 2px 0px; text-align:center; font-weight:bold;">
                                                            10% off
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;font-weight: bold; text-align:center; letter-spacing:3px;">
                                                            + Free Shipping
                                                        </p>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                	<td>
                                                        <p style=" color:#363636; margin:0; text-align:center;">
                                                            <span style="border: 1px dashed #38b8bf;display: inline-block;padding: 5px 8px 2px;font-size: 30px;line-height: 28px;font-weight: bold;">PBFREESHIP10</span>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td style="padding:0; text-align:center;">
                                                        <a href="https://perfumebooth.com" target="_blank" style="background-color:#38b8bf; text-decoration:none; padding:8px 5px; font-size:20px; font-weight:bold; color:#fff; white-space:nowrap; text-transform:uppercase; display:inline-block; width:200px; text-align:center;">
                                                            Start Shopping
                                                        </a>
                                                    </td>
                                                </tr>
