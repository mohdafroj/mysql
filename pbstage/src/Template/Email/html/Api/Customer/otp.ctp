                                    	...
                                    	<td>
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            <strong><?php echo $otp; ?></strong> is the One Time Password (OTP) for your cash on delivery (COD) on PerfumeBooth Pvt. Ltd. for Rs. <?php echo $amount; ?> on your Mobile ending no. <?php echo substr($mobile, -4, 4); ?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            In case you have not requested for OTP, please contact the Perfumebooth helpline at 011-40098888.
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
