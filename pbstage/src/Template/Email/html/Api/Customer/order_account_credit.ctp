                        ...
                        <tr>
                                            	...
                                            	<tr>
													...
													<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo $creditGiftAmount; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
							...
							<?php }					
							      if( isset($creditPointsAmount) && ($creditPointsAmount > 0) ){?>			
                                            	<tr>
													...
													<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo $creditPointsAmount; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
							...
							<?php }				
								  if( isset($creditCashAmount) && ($creditCashAmount > 0) ){?>			
                                            	<tr>
													...
													<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo $creditCashAmount; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
							...
							<?php }?>					
                                            	...
                                            	<tr>
                                                	<td colspan="2">
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            Thanks for shopping with PerfumeBooth!
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <table width="150" border="0" cellspacing="0" cellpadding="0" align="left">
                                                        	<tr>
                                                            	<td>
                                                                	<img src="<?php echo !empty($value['image']) ? $value['image']:'http://www.perfumeoffer.com/pb/img/admin/is-base.jpg';?>" alt="<?php echo $value['title'];?>" width="100%" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                	...
                                                	<td>
                                                        <table width="370" border="0" cellspacing="0" cellpadding="0">
                                                        	...
                                                        	<tr>
                                                            	<td>
                                                                    <p style="font-size:15px; color:#666666; margin:0;">
                                                                        <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo $value['price'];?>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                            ...
                            <td align="center"> 
                                    	...
                                    	<td>
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	...
                                                	<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo isset($productTotal) ? $productTotal:0; ?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	...
                                                	<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo isset($discount) ? $discount:0; ?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
								...
								<?php if( isset($paymentMode) && ($paymentMode == 'prepaid') ){?>
                                            	<tr>
                                                	...
                                                	<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo isset($modeAmount) ? $modeAmount:0; ?>
                                                        </p>
                                                    </td>
                                                </tr>
								<?php }?>				
                                            	...
                                            	<tr>
                                                	...
                                                	<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo isset($shipAmount) ? $shipAmount:0; ?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	...
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0; text-align:right;">
                                                            <img src="http://www.perfumeoffer.com/pb/img/admin/rupees.png" alt="rupees" width="6"> <?php echo isset($paymentAmount) ? $paymentAmount:0; ?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
