...
class OrdersController extends AppController
{
    ...
    public function index()
    {
        ...
        if (!empty($orderNumber)) {$filterData['id'] = $orderNumber;}
        ...
        $orders = $this->Orders->find('all', ['fields' => ['id', 'tracking_code', 'email', 'mobile', 'payment_amount', 'created', 'delhivery_pickup_id', 'delhivery_response', 'payment_mode', 'status'], 'conditions' => $filterData, 'order' => ['id' => 'DESC']])
        ...
        $this->set(compact('orders', 'couriers', 'labelPdf', 'shipmentIds'));
        $this->set('_serialize', ['orders', 'couriers', 'labelPdf', 'shipmentIds']);
    }
    ...
    public function exports()
    {
        ...
        $data = $this->Orders->find('all', ['conditions' => $filterData, 'limit' => $limit, 'offset' => $offset])
            ->select(['id', 'email', 'mobile', 'payment_amount', 'discount', 'payment_mode', 'mode_amount', 'ship_method', 'ship_amount', 'coupon_code', 'tracking_code', 'created', 'status', 'shipping_firstname', 'shipping_lastname', 'shipping_address', 'shipping_city', 'shipping_state', 'shipping_country', 'shipping_pincode', 'shipping_email', 'shipping_phone'])
            ->where(function ($exp, $q) use ($createdFrom, $createdTo) {
                return $exp->between('created', $createdFrom, $createdTo);
            })
            ->contain([
        ...
        $_serialize = 'dataList';
        $_header = ['Order ID', 'Email', 'Mobile', 'Total Amount', 'Discount', 'Payment Mode', 'Mode Amount', 'Ship Method', 'Ship Amount', 'Coupon Code', 'Tracking Code', 'Created', 'Status', 'SKU Code', 'Title', 'Size', 'Price', 'Qty', 'Tax', 'Shipping Firstname', 'Shipping Lastname', 'Shipping Address', 'Shipping City', 'Shipping State', 'Shipping Country', 'Shipping Pincode', 'Shipping Email', 'Shipping Phone'];
        $_extract = ['id', 'email', 'mobile', 'payment_amount', 'discount', 'payment_mode', 'mode_amount', 'ship_method', 'ship_amount', 'coupon_code', 'tracking_code', 'created', 'status', 'sku_code', 'title', 'size', 'price', 'qty', 'goods_tax', 'shipping_firstname', 'shipping_lastname', 'shipping_address', 'shipping_city', 'shipping_state', 'shipping_country', 'shipping_pincode', 'shipping_email', 'shipping_phone'];
