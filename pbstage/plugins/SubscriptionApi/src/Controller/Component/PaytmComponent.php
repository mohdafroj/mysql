...
class PaytmComponent extends Component
{
    ...
    protected $PAYTM_MERCHANT_KEY = 'fAIotJuFo2_tiBAI'; ////Change this constant's value with Merchant key downloaded from portal
    protected $PAYTM_MERCHANT_MID = 'AZNBYB27368703441780'; ////Change this constant's value with MID (Merchant ID) received from Paytm
    protected $PAYTM_MERCHANT_WEBSITE = 'WEBSTAGING'; ////Change this constant's value with Website name received from Paytm
    ...
    protected $PAYTM_STATUS_QUERY_NEW_URL = 'https://securegw-stage.paytm.in/order/status';
    protected $PAYTM_TXN_URL = 'https://securegw-stage.paytm.in/order/process';

    public function __construct()
    {
        if ($this->PAYTM_ENVIRONMENT == 'PROD') {
            $this->PAYTM_DOMAIN = 'https://secure.paytm.in';
            $this->PAYTM_MERCHANT_KEY = PC['PAYTM']['PAYTM_MERCHANT_KEY'];
            $this->PAYTM_MERCHANT_MID = PC['PAYTM']['PAYTM_MERCHANT_MID'];
            $this->PAYTM_MERCHANT_WEBSITE = PC['PAYTM']['PAYTM_MERCHANT_WEBSITE'];
            $this->INDUSTRY_TYPE_ID = PC['PAYTM']['INDUSTRY_TYPE_ID'];
            $this->PAYTM_STATUS_QUERY_NEW_URL = PC['PAYTM']['PAYTM_STATUS_QUERY_NEW_URL'];
            $this->PAYTM_TXN_URL = PC['PAYTM']['PAYTM_TXN_URL'];
        }
