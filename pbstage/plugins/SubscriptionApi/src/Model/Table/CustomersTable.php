...
class CustomersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('SubscriptionApi.Addresses', [
            'foreignKey' => 'customer_id',
        ]);
        $this->hasMany('SubscriptionApi.Memberships', [
            'foreignKey' => 'customer_id',
        ]);
        $this->hasMany('SubscriptionApi.CustomerReferrals', [
            'foreignKey' => 'customer_id',
        ]);
        ...
        $this->hasMany('SubscriptionApi.Carts', [
            'foreignKey' => 'customer_id',
        ]);
    }
