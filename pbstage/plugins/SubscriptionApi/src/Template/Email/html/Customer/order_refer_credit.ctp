                                    	...
                                    	<td>
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td colspan="2">
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            <b>Your account has been credited with Rs. <?php echo $cash; ?> as you refer to <?php echo $toName?></b>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
                                            	...
                                            	<tr>
                                                	<td colspan="2">
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            You can use these for additional discount on your purchase. 
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
