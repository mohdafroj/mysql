                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                    <tbody>
                        ...
                        <tr>
							...
							<?php if( isset($credit_voucher) && ($credit_voucher > 0) ){?>			
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            Voucher. 
													...
													<td>
                                                        ...
                                                        <?php echo $price_logo.' '.$credit_voucher; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
							...
							<?php }					
							      if( isset($credit_points) && ($credit_points > 0) ){?>			
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            Points Amount 
													...
													<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                            <?php echo $price_logo.' '.$credit_points; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
							...
							<?php }				
								  if( isset($credit_cash) && ($credit_cash > 0) ){?>			
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            Cash
													...
													<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                        <?php echo $price_logo.' '.$credit_cash; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
							...
							<?php }?>					
                                            	...
                                            	<tr>
													...
													<td>
                                                        <p style="font-size:15px; color:#666666; margin:0; text-align:right;">
                                                           <?php echo PC['ORDER_PREFIX'] ?? ''; ?><?php echo $id ?? 0; ?>
                                                        </p>
													</td>
                                                </tr>
                                            	<tr>
