                                        	...
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td style="padding:0; text-align:center;">
                                                        <a href="<?php echo PC['COMPANY']['website']; ?>" target="_blank" style="background-color:#38b8bf; text-decoration:none; padding:8px 5px; font-size:20px; font-weight:bold; color:#fff; white-space:nowrap; text-transform:uppercase; display:inline-block; width:150px; text-align:center;">
                                                        Start Shopping
                                                        </a>
                                                    </td>
                                                </tr>
