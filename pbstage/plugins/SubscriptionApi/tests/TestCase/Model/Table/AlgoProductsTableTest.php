...
use SubscriptionApi\Model\Table\AlgoProductsTable;

/**
 * SubscriptionApi\Model\Table\AlgoProductsTable Test Case
 */
class AlgoProductsTableTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \SubscriptionApi\Model\Table\AlgoProductsTable
     */
    public $AlgoProducts;
     ...
     */
    public $fixtures = [
        'plugin.subscription_api.algo_products'
    ];
