...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<?=$this->Form->text('Products.discount', ['class' => 'form-control', 'maxlength' => 5, 'style' => 'width:20%;text-align:right;', 'placeholder' => 'Discount']);?>
												<span class="text-red">
													<?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											...
											<div class="input-group date" style="width:61%;">
												<label class="col-sm-4 control-label" style="padding-left:0px;padding-right:1px;">Title colour</label>
...
?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Sold Item</label>
                                        <div class="col-sm-9">
                                        	<?=$this->Form->number('Products.sold', ['class' => 'form-control', 'style' => 'width:100%;', 'placeholder' => 'Enter sold number']);?>
                                        </div>
                                    </div>
                                    <div class="form-group">
