...
.invoice_row .table > tbody > tr > td, .invoice_row .table > tbody > tr > th, .invoice_row .table > tfoot > tr > td, .invoice_row .table > tfoot > tr > th, .invoice_row .table > thead > tr > td, .invoice_row .table > thead > tr > th{ padding:8px 15px;font-size:22px;}
