                    ...
                    <div class="col-sm-6 col-xs-12 flex_box no-padding-left xs-no-padding"><!-- start of col_div -->
                        <div class="box box-default"><!-- start of box_div -->
                            <div class="col-sm-12 col-xs-12">
								...
								<?php }else{
									 echo $this->Form->postLink(__('Set Default Address'), ['action' => 'addresses', $id, 'key', md5($id)], ['block' => false, 'data'=>['address-id'=>$value->id], 'method'=>'patch', 'class' =>'btn btn-warning col-sm-4 col-xs-4 no-padding', 'confirm' => __('Are you sure you want to set default address # {0}?', $value->id)]);
								 } ?>
							</div>
                            ...
                            <div class="col-sm-12 col-xs-12 flex_box_content price_detail"><!-- start of box_content -->
                                <div class="box-body">
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        	<?= $this->Form->text('state', ['style'=>'width:100%;','class'=>'form-control'])?>
											<span class="text-red">
												<?php
													echo $error['state']['_empty'] ?? NULL;
													echo $error['state']['length'] ?? NULL; 
													echo $error['state']['custom'] ?? NULL; 
												?>
											</span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        	<?= $this->Form->select('country', $countryList, ['empty'=>false,'style'=>'width:100%;','class'=>'form-control'])?>
											<span class="text-red">
												<?php
													echo $error['country']['_empty'] ?? NULL;
													echo $error['country']['length'] ?? NULL; 
													echo $error['country']['custom'] ?? NULL; 
												?>
											</span>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?= $this->Form->hidden('customer_id', ['value'=>$id]); ?>
