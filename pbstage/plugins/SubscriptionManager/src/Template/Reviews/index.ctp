        ...
        <div class="col-sm-12 col-xs-12 table_view responsive-mobile-table"><!-- start of table -->
                ...
                <tbody>
                    <tr><!-- start of row_1 -->
                        ...
                        <td data-title="Country">
                            <?=$this->Form->select('location_id', $locations, ['value' => $locationId, 'empty' => true, 'style' => 'width:100%;', 'class' => 'form-control'])?>
                        </td>
                        <td data-title="Email">
           ...
           <?php foreach ($reviews as $value): ?>
                    <tr>
                        ...
                        <td data-title="Country"><?=h($value->location->title)?></td>
                        ...
                        <td data-title="Created Date"><?=$this->Admin->emptyDate($value->created)?></td>
