                                        	...
                                        	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                            	...
                                            	<tr>
                                                	<td>
                                                        ...
                                                        <strong><?php echo $otp; ?></strong> is the One Time OTP for account registration at <?=PC['COMPANY']['tag']?>
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            This OTP is valid for 3 minutes or 1 successful attempt whichever is earlier.
                                                        </p>
                                                    </td>
                                                </tr>
                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            In case you have not requested for OTP, please contact the <?=PC['COMPANY']['tag']?> helpline at <?=PC['COMPANY']['phone']?>.
                                                        </p>
                                                    </td>
                                                </tr>
                                            	<tr>
