                                            	...
                                            	<tr>
                                                	<td>
                                                        <p style="font-size:16px; color:#363636; margin:0;">
                                                            <?php echo $otp; ?> is the One Time Password (OTP) for your cash on delivery (COD) on <?=PC['COMPANY']['tag']?> for Rs. <?php echo $amount; ?> on your Mobile ending no. <?php echo substr($mobile, -4, 4); ?>
                                                        </p>
                                                    </td>
                                                </tr>
