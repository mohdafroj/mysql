                	...
                	<tr><!-- start of content -->
                    	<td style="color:#000000;display:block;font-weight:500;max-width:100%;margin:0 auto;clear:both;">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                    ...
                                                    <td>
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p style="font-size:.85rem; color:#363636; margin:0; line-height:1.7;">
                                                                        We know how to make your day better!
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p style="font-size:.85rem; color:#363636; margin:0; line-height:1.7;">
                                                                        Your order has been shipped out from our warehouse.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                ...
                                <?php if ( isset($tracking_code) && !empty($tracking_code) ) {?>                            
                                                            <tr>
                                                                <td width="100%" height="25" style="font-size:0;"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <p style="font-size:.85rem; color:#363636; margin:0; line-height:1.7;">
                                                                        AWB No. : <b><?php echo $tracking_code; ?></b>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                <?php }?>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p style="font-size:.85rem; color:#363636; margin:0; line-height:1.7;">
                                                                        Courier Service : <b><?php echo $courier ?? 'NA'; ?></b>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                <?php if ( isset($tracking_link) && !empty($tracking_link) ) {?>                            
                                                            <tr>
                                                                <td width="100%" height="30" style="font-size:0;"></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center">
                                                                	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    	<tr>
                                                                        	<td align="center" style="background:#ee9591; padding:.75rem .9rem;">
                                                                            	<a href="<?php echo $tracking_link; ?>" target="_blank" style="text-decoration:none; font-size:1.2rem; font-weight:bold; color:#3b4e76; white-space:nowrap; text-transform:uppercase; letter-spacing:0.5px; display:inline-block;">
                                                                                    Track Order
                                                                                </a>
                                                                            </td>
                                                                        </tr>
