...
use SubscriptionManager\Model\Table\CustomerPlansTable;

/**
 * SubscriptionManager\Model\Table\CustomerPlansTable Test Case
 */
class CustomerPlansTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \SubscriptionManager\Model\Table\CustomerPlansTable
     */
     ...
     */
    public $fixtures = [
        'plugin.subscription_manager.customer_plans',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CustomerPlans') ? [] : ['className' => CustomerPlansTable::class];
        $this->CustomerPlans = TableRegistry::get('CustomerPlans', $config);
    }
