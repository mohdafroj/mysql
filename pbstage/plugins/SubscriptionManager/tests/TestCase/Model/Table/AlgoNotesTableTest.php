...
use SubscriptionManager\Model\Table\AlgoNotesTable;

/**
 * SubscriptionManager\Model\Table\AlgoNotesTable Test Case
 */
class AlgoNotesTableTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \SubscriptionManager\Model\Table\AlgoNotesTable
     */
    public $AlgoNotes;
     ...
     */
    public $fixtures = [
        'plugin.subscription_manager.algo_notes'
    ];
