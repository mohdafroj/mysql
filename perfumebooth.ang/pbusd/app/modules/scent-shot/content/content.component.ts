...
export class ContentComponent implements OnInit {
	...
	constructor(private config:Myconfig, private meta:Meta, private title: Title, private el:ElementRef) {
		
	}

	ngOnInit() {
		this.title.setTitle('Scent Shot : Buy Luxury Perfume Scent Shot for Men and Women');
		...
		let description: MetaDefinition = { name: 'description', content: 'Buy one perfume scent shot and get 7 international brands perfumes with seven unique fragrance at low cost. Easy to carry your perfumes scent shot in your pocket.'};
