...
export class RefillsComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.title.setTitle('Buy Refills Pack of Perfume Scent Shot');
		...
		let description: MetaDefinition = { name: 'description', content: 'Buy super saver perfume refill pack of scent shot at low price. Perfumebooth offers 100% original and genuine perfumes of top international brands.'};
