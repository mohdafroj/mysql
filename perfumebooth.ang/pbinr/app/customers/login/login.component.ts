...
export class LoginComponent implements OnInit,DoCheck {
	...
	constructor(private seo: SeoService, private sanitizer:DomSanitizer, private loc:Location, private router: Router, private route: ActivatedRoute, private config:Myconfig, private auth: CustomerService) {
