...
export class SecurityComponent implements OnInit {
  ...
  msg:string;
  response:any;
  constructor(private seo: SeoService, private titleService: Title, private router: Router, private route: ActivatedRoute, private config:Myconfig, private auth: CustomerService) {
  ...
  ngOnInit() {
		this.seo.ogMetaTag('Customer Security Page', 'Customer Security page description');
